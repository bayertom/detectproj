...
// Method: Simplex method, no shifts are determined
...
#ifndef FAnalyzeProjV2S2_H
#define FAnalyzeProjV2S2_H
...
class FAnalyzeProjV2S2
{
        ...
        public:
                ...
                FAnalyzeProjV2S2(Container <Node3DCartesian <T> *> &nl_test_, Container <Point3DGeographic <T> *> &pl_reference_, typename TMeridiansList <T> ::Type &meridians_, typename TParallelsList <T> ::Type &parallels_,
