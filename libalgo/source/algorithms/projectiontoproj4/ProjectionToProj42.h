...
#ifndef ProjectionToProj42_H
#define ProjectionToProj42_H
...
class ProjectionToProj4
{
	...
	public:
		template <typename T>
		static std::string ProjectionToProj4String (const std::shared_ptr<Projection <T> > proj);
...
#include "ProjectionToProj42.hpp"
