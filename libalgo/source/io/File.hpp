...
void File::load3DPoints(const char * file, List &l)
{
	...
	const TFileWords file_content = loadFileToWords(file);
...
template <typename Point, typename List>
void File::convertTo2DPoints(List &l, const TFileWords &file_content)
{
...
template <typename Point, typename List>
void File::convertTo3DPointsD(List &l, const TFileWords &file_content)
{
...
template <typename Point, typename List>
void File::convertTo2DPointsD(List &l, const TFileWords &file_content)
{
