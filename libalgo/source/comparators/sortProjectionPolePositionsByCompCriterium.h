// Description: Sort all generated map projection positions by complex criteria values
...
#ifndef sortProjectionPolePositionsByCompCriterium_H
#define sortProjectionPolePositionsByCompCriterium_H
...
class sortProjectionPolePositionsByCompCriterium
{
        public:
                ...
                {
                        return ( pa1.complex_crit < pa2.complex_crit );
                }
};
